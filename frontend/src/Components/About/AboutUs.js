                  ...
                  <div className="row g-0 ">
                    <div className="col-lg-6 bg-partone">
                      <div className="p-5">
                        ...
                        <div>
                                <p > We are undergraduates of Bach. of Computer Science in University of Ruhuna. In our final year group project we develop a Online gym registration Platform for every registered gym in Sri Lanka. In below there is our tem memnbers.</p>
                                   </div>
                    ...
                    <div className="col-lg-6 bg-parttwo text-white">
                      <div className="p-5">
                        <h3 className="fw-normal mb-5">Team Members&emsp;&emsp;</h3>
